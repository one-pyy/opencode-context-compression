...
[compaction/failure-handling-and-user-notice.md] — 半实现：跨发送累计三次整链失败、terminal failure 与自动跳过已实现；database-backed toast 和 user-role notice 未实现
