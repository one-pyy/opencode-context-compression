...
[decisions/2026-07-03_async-compaction-with-decoupled-replacement-gate.md] — 压缩 N+1 启动并解耦替换门槛；每次发送只跑一轮完整模型链，整链失败跨发送累计三次 #compaction #architecture #runtime #scheduling #async #replacement-gate #retry #failure-handling
